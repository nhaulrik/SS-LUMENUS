...
- Name: patch-table.spec.js >> Patch table — inline key editing >> changing the key inline updates the input value immediately
- Location: e2e\patch-table.spec.js:63:3
