...
- Name: patch-table.spec.js >> Patch table — inline key editing >> changed key persists after switching slides and returning
- Location: e2e\patch-table.spec.js:81:3
