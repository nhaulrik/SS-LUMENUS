...
- Name: patch-table.spec.js >> Patch table — inline hint editing >> editing the hint inline updates the value without opening a modal
- Location: e2e\patch-table.spec.js:97:3
