...
- Name: patch-table.spec.js >> Patch table — inline max chars editing >> setting max chars inline is reflected immediately in the input
- Location: e2e\patch-table.spec.js:118:3
