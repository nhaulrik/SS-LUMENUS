...
- Name: patch-table.spec.js >> Patch table — inline max chars editing >> max chars persist after switching slides and returning
- Location: e2e\patch-table.spec.js:128:3
