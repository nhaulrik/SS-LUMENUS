...
**Output**: A design brief that guides implementation.
...
**3. Design Direction**
How this should feel. What aesthetic approach fits. Reference any existing project design context and explain how this feature should express it.
...
Once confirmed, the brief is complete and can be used to guide implementation.